![Melody Maker](https://github.com/Nobody277/Melody-Maker/blob/main/Melody%20Maker.jpg)
...
1. Navigate to the [releases tab](https://github.com/Nobody277/Melody-Maker/releases) of this GitHub repository.
...
Make sure to review the [contribution guidelines](https://github.com/Nobody277/Melody-Maker/blob/main/CONTRIBUTING.md) before making your contribution to ensure a smooth collaboration process.

## License

(This project is licensed under the GNU General Public License v3.0 (GPLv3) - see the [LICENSE.md](https://github.com/Nobody277/Melody-Maker/blob/main/LICENSE) file for details)
...
- **GitHub Issues:** Alternatively, you can [open an issue](https://github.com/Nobody277/Melody-Maker/issues) right here on GitHub, and I'll respond as soon as I can.
...
For the most stable and latest version of the script, always download it from our [GitHub repository](https://github.com/Nobody277/Melody-Maker). We don't recommend downloading from the Fortitude website as it has issues causing crashes for a majority of users.

**2. Which file should I download on the GitHub page?**
Always download the file tagged as "latest." Generally, this will be the `Melody_Maker.lua` file, found in the [releases tab](https://github.com/Nobody277/Melody-Maker/releases).

**3. I have more questions or encountered a bug, how can I reach out?**
Don't hesitate to message `nobody_272` directly or in the [Fortitude Discord server](https://discord.gg/fortitudemod) or open an [issue on GitHub](https://github.com/Nobody277/Melody-Maker/issues). We appreciate your feedback and are here to help with any issues you encounter.
